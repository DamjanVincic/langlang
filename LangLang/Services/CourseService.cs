...
public class CourseService : ICourseService
{
        ...
        bool areApplicationsClosed, int teacherId)
    {
        ...
        {
            Teacher? oldTeacher = course.TeacherId != null ? _userRepository.GetById(course.TeacherId.Value) as Teacher : null;
    ...
    {
        Course course = _courseRepository.GetById(id) ?? throw new InvalidInputException("Course doesn't exist.");
        Teacher? teacher = course.TeacherId != null ? _userRepository.GetById(course.TeacherId.Value) as Teacher : null;
